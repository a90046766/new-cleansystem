...
export default function AppShell() {
    ...
    return (_jsxs("div", { className: "flex min-h-screen bg-[#F5F7FB]", children: [_jsx(DesktopNav, {}), _jsxs("main", { className: "flex-1", children: [_jsx("div", { className: "sticky top-0 z-10 border-b bg-white/80 px-4 py-3 backdrop-blur", children: _jsx("div", { className: "text-base font-semibold text-gray-800", children: "\u6D17\u6FEF\u6D3E\u5DE5\u7CFB\u7D71" }) }), _jsx("div", { className: "px-4 py-4", children: _jsx(Outlet, {}) })] })] }));
}
